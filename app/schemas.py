...
class MapaGerarTextoRequest(BaseModel):
    ...
    max_ramos: int = Field(default=12, ge=4, le=14, description="Ramos principais (nível 1)")
    profundidade: int = Field(default=4, ge=3, le=6, description="Níveis abaixo da raiz")
    max_filhos: int = Field(default=6, ge=3, le=10, description="Máx. de filhos por nó")
    instrucoes_extras: Optional[str] = Field(default=None, max_length=500)
...
class MapaGerarMultiRequest(BaseModel):
    ...
    max_ramos: int = Field(default=12, ge=4, le=14)
    profundidade: int = Field(default=4, ge=3, le=6)
    max_filhos: int = Field(default=6, ge=3, le=10)
    instrucoes_extras: Optional[str] = Field(default=None, max_length=500)
    idioma: Idioma = Field(default="pt")
